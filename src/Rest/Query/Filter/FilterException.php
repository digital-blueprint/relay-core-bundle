...
class FilterException extends \Exception
{
    ...
    /**
     * @deprecated Use FilterException::LOGICAL_OPERATOR_UNDEFINED instead
     */
    public const CONJUNCTION_UNDEFINED = self::LOGICAL_OPERATOR_UNDEFINED;
    public const LOGICAL_OPERATOR_UNDEFINED = 4;
